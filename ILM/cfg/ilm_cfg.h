/**
 * \file ./master/ILM/cfg/ilm_cfg.h
 * \brief User defined configuration file (default template)
 * \ingroup ILM
 */
...
#define ILM_USE_HOOK_MISS_LET	1		/**< \brief Use LET Miss Hook													*/

#define ILM_USE_PRIOB			0		/**< \brief Enable Priority boosting											*/

#define ILM_USE_OS_TERM_CTX		0		/**< \brief Use additional SetEvent at Task Termination							*/
#define ILM_USE_OS_OSEK_ECC		0		/**< \brief Use Extenden Conformance Class (ECC) Tasks instead of Basic (BCC)	*/
#define ILM_USE_OS_MIN_BARRIER	0		/**< \brief Use minimal synchronization barrier implementation					*/
...
#define ILM_MAX_LET_OFFSET		1875	/**< \brief Maximum offset in LET table, used for optimized type definitions	*/
#define ILM_MAX_OS_TASKS		64		/**< \brief Maximum number of OS tasks, used for optimized type definitions		*/
